...
/* Smarty version 4.3.1, created on 2026-05-28 10:04:24
  from 'app:controllersgridusersauthorformauthorForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6a17a2a8134b75_31092725',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '06932f1259fee8e7c6747e1a2b9752b223abefd1' => 
    array (
      0 => 'app:controllersgridusersauthorformauthorForm.tpl',
      1 => 1732939528,
      2 => 'app',
    ),
  ),
...
function content_6a17a2a8134b75_31092725 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
...
while ($_block_repeat) {
ob_start();?>
		<?php if ($_smarty_tpl->tpl_vars['requireAuthorCompetingInterests']->value) {?>
			<?php $_block_plugin2 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
if (!is_callable(array($_block_plugin2, 'smartyFBVFormSection'))) {
throw new SmartyException('block tag \'fbvFormSection\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('title'=>"author.competingInterests"));
$_block_repeat=true;
echo $_block_plugin2->smartyFBVFormSection(array('title'=>"author.competingInterests"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('id'=>"competingInterests",'type'=>"textarea",'multilingual'=>true,'rich'=>true,'label'=>"author.competingInterests.description",'value'=>$_smarty_tpl->tpl_vars['competingInterests']->value),$_smarty_tpl ) );?>

			<?php $_block_repeat=false;
echo $_block_plugin2->smartyFBVFormSection(array('title'=>"author.competingInterests"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin3->smartyFBVFormSection(array('id'=>"userGroupId",'title'=>"submission.submit.contributorRole",'list'=>true,'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php $_block_plugin4 = isset($_smarty_tpl->smarty->registered_plugins['block']['iterate'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['iterate'][0][0] : null;
if (!is_callable(array($_block_plugin4, 'smartyIterate'))) {
...
$_block_repeat=true;
echo $_block_plugin4->smartyIterate(array('from'=>'authorUserGroups','item'=>'userGroup'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_smarty_tpl->_assignInScope('checked', false);
			...
			<?php $_block_repeat=false;
echo $_block_plugin4->smartyIterate(array('from'=>'authorUserGroups','item'=>'userGroup'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin3->smartyFBVFormSection(array('id'=>"userGroupId",'title'=>"submission.submit.contributorRole",'list'=>true,'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
