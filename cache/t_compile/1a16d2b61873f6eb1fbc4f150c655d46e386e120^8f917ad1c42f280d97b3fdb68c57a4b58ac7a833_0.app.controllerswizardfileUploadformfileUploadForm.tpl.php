...
/* Smarty version 4.3.1, created on 2026-07-07 06:00:17
  from 'app:controllerswizardfileUploadformfileUploadForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6a4c79d105dec3_44570215',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8f917ad1c42f280d97b3fdb68c57a4b58ac7a833' => 
    array (
      0 => 'app:controllerswizardfileUploadformfileUploadForm.tpl',
      1 => 1783307629,
      2 => 'app',
    ),
  ),
...
function content_6a4c79d105dec3_44570215 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('revisionOnlyWithoutFileOptions', true);
	...
	<?php if (empty($_smarty_tpl->tpl_vars['submissionFileOptions']->value)) {?>
				<?php if (is_numeric($_smarty_tpl->tpl_vars['revisedFileId']->value)) {
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'fatalError' ][ 0 ], array( "A revised file id cannot be given when uploading a new file!" ));
}?>
		<?php $_smarty_tpl->_assignInScope('showFileSelector', false);?>
	<?php } else { ?>
				<?php $_smarty_tpl->_assignInScope('showFileSelector', true);?>
...
<?php $_smarty_tpl->_assignInScope('uploadFormId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( "uploadForm" )));
$_smarty_tpl->_assignInScope('pluploadControl', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( "plupload" )));
$_smarty_tpl->_assignInScope('browseButtonId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'uniqid' ][ 0 ], array( "browseButton" )));
echo '<script'; ?>
...
').pkpHandler(
			'$.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler',
			{
				...
				presetRevisedFileId: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['revisedFileId']->value ));?>
,
...
?>
						<?php if (!empty($_smarty_tpl->tpl_vars['fileGenre']->value)) {?>
							<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['submissionFileId']->value ));?>
: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'json_encode' ][ 0 ], array( $_smarty_tpl->tpl_vars['fileGenre']->value ));
