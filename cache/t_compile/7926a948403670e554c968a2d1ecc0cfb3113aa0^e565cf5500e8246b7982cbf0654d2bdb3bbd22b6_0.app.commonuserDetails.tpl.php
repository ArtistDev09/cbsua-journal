<?php
/* Smarty version 4.3.1, created on 2026-05-28 10:04:24
  from 'app:commonuserDetails.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6a17a2a818b697_00893537',
...
function content_6a17a2a818b697_00893537 (Smarty_Internal_Template $_smarty_tpl) {
$_block_plugin6 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin6->smartyFBVFormArea(array('id'=>"userDetails"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin7->smartyFBVFormSection(array('title'=>"user.name"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin7->smartyFBVFormSection(array('title'=>"user.name"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
$_block_repeat=true;
echo $_block_plugin8->smartyFBVFormSection(array('for'=>"preferredPublicName",'description'=>"user.preferredPublicName.description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin8->smartyFBVFormSection(array('for'=>"preferredPublicName",'description'=>"user.preferredPublicName.description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('for'=>"username",'description'=>$_smarty_tpl->tpl_vars['usernameInstruction']->value,'translate'=>false), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php if (!$_smarty_tpl->tpl_vars['userId']->value) {?>
...
$_block_repeat=true;
echo $_block_plugin10->smartyFBVFormSection(array('title'=>"user.username",'suppressId'=>"true"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
					<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['username']->value ));?>

				<?php $_block_repeat=false;
echo $_block_plugin10->smartyFBVFormSection(array('title'=>"user.username",'suppressId'=>"true"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php }?>
		<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('for'=>"username",'description'=>$_smarty_tpl->tpl_vars['usernameInstruction']->value,'translate'=>false), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
$_block_repeat=true;
echo $_block_plugin11->smartyFBVFormSection(array('title'=>"about.contact"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin11->smartyFBVFormSection(array('title'=>"about.contact"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
$_block_repeat=true;
echo $_block_plugin12->smartyFBVFormSection(array('title'=>"grid.user.authSource",'for'=>"authId"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin12->smartyFBVFormSection(array('title'=>"grid.user.authSource",'for'=>"authId"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
$_block_repeat=true;
echo $_block_plugin13->smartyFBVFormArea(array('id'=>"passwordSection",'title'=>"user.password"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin14->smartyFBVFormSection(array('for'=>"password",'description'=>$_smarty_tpl->tpl_vars['passwordInstruction']->value,'translate'=>false), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin14->smartyFBVFormSection(array('for'=>"password",'description'=>$_smarty_tpl->tpl_vars['passwordInstruction']->value,'translate'=>false), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin15->smartyFBVFormSection(array('title'=>"grid.user.generatePassword",'for'=>"generatePassword",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin15->smartyFBVFormSection(array('title'=>"grid.user.generatePassword",'for'=>"generatePassword",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php }?>
...
$_block_repeat=true;
echo $_block_plugin16->smartyFBVFormSection(array('title'=>"grid.user.mustChangePassword",'for'=>"mustChangePassword",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin16->smartyFBVFormSection(array('title'=>"grid.user.mustChangePassword",'for'=>"mustChangePassword",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin13->smartyFBVFormArea(array('id'=>"passwordSection",'title'=>"user.password"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
...
$_block_repeat=true;
echo $_block_plugin17->smartyFBVFormSection(array('for'=>"country",'title'=>"common.country"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin17->smartyFBVFormSection(array('for'=>"country",'title'=>"common.country"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin18->smartyFBVFormSection(array('title'=>"grid.user.notifyUser",'for'=>"sendNotify",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin18->smartyFBVFormSection(array('title'=>"grid.user.notifyUser",'for'=>"sendNotify",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }
$_block_repeat=false;
echo $_block_plugin6->smartyFBVFormArea(array('id'=>"userDetails"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
...
$_block_repeat=true;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"userFormExtendedLeft"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin20->smartyFBVFormSection(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin20->smartyFBVFormSection(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin21->smartyFBVFormSection(array('title'=>"user.workingLanguages",'list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php $_block_repeat=false;
echo $_block_plugin21->smartyFBVFormSection(array('title'=>"user.workingLanguages",'list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin22->smartyFBVFormSection(array('for'=>"interests"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin22->smartyFBVFormSection(array('for'=>"interests"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
...
$_block_repeat=true;
echo $_block_plugin23->smartyFBVFormSection(array('for'=>"affiliation"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin23->smartyFBVFormSection(array('for'=>"affiliation"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin19->smartyFBVFormArea(array('id'=>"userFormExtendedLeft"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array());
$_block_repeat=true;
echo $_block_plugin27->smartyFBVFormSection(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin28->smartyFBVFormSection(array('title'=>"grid.user.userDetails"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			<?php echo $_smarty_tpl->tpl_vars['extraContent']->value;?>

		<?php $_block_repeat=false;
echo $_block_plugin28->smartyFBVFormSection(array('title'=>"grid.user.userDetails"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php } else { ?>
...
?>
	...
	<?php }
$_block_repeat=false;
echo $_block_plugin27->smartyFBVFormSection(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
}
