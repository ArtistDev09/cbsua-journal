 ...
 *}
{include file="frontend/components/header.tpl" pageTitle="Editorial Policy"}
...
<div id="main-content" class="page page_about">
    ...
    <div class="about-document-wrapper">
        ...
        <div class="about-content">
            ...
            {* Section 1: Overview of Editorial Process *}
            ...
            {* Section 2: Submission & Authorship *}
            ...
            {* Section 4: Revisions & Proofreading *}
            ...
            {* Section 6: Scientific Misconduct & Other Fraud *}
