 ...
 * Modernized "Guidelines for Authors" document-style design.
 *}
...
<div id="main-content" class="page page_submissions">
    ...
    <div class="sub-document-wrapper">
        ...
        <div class="sub-content">
            ...
            {* CTA Callout Banner for Login / Submit *}
            {if $isUserLoggedIn}
                <div class="sub-cta-banner">
                    ...
                    <div class="sub-cta-buttons">
                        <a href="{url page="submission" op="wizard"}" class="btn-sub-primary">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>
                            Start New Submission
                        </a>
                        <a href="{url page="submissions"}" class="btn-sub-secondary">
                            View Submissions
                        </a>
                    </div>
                </div>
            {else}
                <div class="sub-cta-banner">
                    ...
                    <div class="sub-cta-buttons">
                        <a href="{url page="login"}" class="btn-sub-primary">
                        ...
                        <a href="{url page="user" op="register"}" class="btn-sub-secondary">
                            Register
                        </a>
                    </div>
                </div>
            ...
            {* Section 5: Elsevier Numeric Citation Style *}
            ...
            {* Section 6: Reference List Rules *}
            ...
            {* Section 7: Reference Software Guide *}
            ...
            {* Section 8: Headings & Paragraph Rules *}
                    ...
                    <div class="checklist-grid">
                        {foreach from=$submissionChecklist item=checklistItem}
                            <div class="checklist-card">
                                ...
                                <div class="checklist-text">{$checklistItem.content|nl2br}</div>
                            </div>
                        {/foreach}
                    </div>
                </section>
            ...
            {if $currentJournal->getLocalizedSetting('copyrightNotice')}
                <section id="copyright" class="sub-section">
                    ...
                    <p>{$currentJournal->getLocalizedSetting('copyrightNotice')}</p>
                </section>
            {/if}
